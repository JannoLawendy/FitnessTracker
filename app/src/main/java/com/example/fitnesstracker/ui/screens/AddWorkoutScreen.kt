...
fun AddWorkoutScreen(
    ...
    Column(
        ...
        Text("Add Workout", style = MaterialTheme.typography.headlineSmall, fontWeight = FontWeight.Bold)
        ...
        Button(
            onClick = {
                ...
                if (title.isBlank() || type.isBlank() || date.isBlank()) {
                    ...
                    onSaveWorkout(
                        Workout(title = title, type = type, duration = durationValue, calories = caloriesValue, date = date)
                    )
                    onCancel()
                }
            },
